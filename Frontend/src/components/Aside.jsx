    ...
    <>
      <aside className="hidden md:fixed md:top-16 md:bottom-0 md:left-0 md:w-64 md:bg-gradient-to-br md:from-black md:to-gray-800 md:text-white md:shadow-md md:overflow-y-auto md:flex md:flex-col">
        <div className="flex flex-col p-4 gap-2">
          <h2 className="text-2xl font-bold mb-4 mt-6">Menú</h2>
          <ul className="space-y-2 flex flex-col gap-2">
            ...
            <li><a href="/groups" className="flex items-center gap-2 text-xl font-bold text-gray-300 hover:text-blue-500"><MdGroups /> Grupos</a></li>
            <li><a href="/people" className="flex items-center gap-2 text-xl font-bold text-gray-300 hover:text-blue-500"><IoPeople /> People</a></li>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-gradient-to-br from-black to-gray-800 text-white shadow-inner flex justify-around py-2 md:hidden">
        ...
        <a href="/groups" className="hover:text-blue-500"><MdGroups size={24} /></a>
        <a href="/people" className="hover:text-blue-500"><IoPeople size={24} /></a>
